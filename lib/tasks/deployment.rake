...
namespace :production do
  ...
  task :pull_db do
    ...
    system 'heroku db:pull --remote production --confirm twinbox-production'
...
namespace :staging do
  ...
  task :transfer_db do
    ...
    system  'heroku pgbackups:restore DATABASE `heroku pgbackups:url --remote production` --remote staging --confirm twinbox-staging'
